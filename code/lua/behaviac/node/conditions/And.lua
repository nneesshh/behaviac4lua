--- Behaviac lib Component: and condition node.
-- @module And.lua
-- @author n.lee
-- @copyright 2016
-- @license MIT/X11
...
local Cls_And = class("And", Condition)
_G.ADD_BEHAVIAC_DYNAMIC_TYPE("And", Cls_And)
_G.BEHAVIAC_DECLARE_DYNAMIC_TYPE("And", "Condition")
local _M = Cls_And
